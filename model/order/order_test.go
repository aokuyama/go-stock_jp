...
func TestOrder(t *testing.T) {
	o, err = order.New(0, "9856", "jpx", "margin_buy", "system", "normal", 0, "more", 100, 200, "2022-01-24", "afternoon", "completed", false)
	...
	o, err = order.New(1, "1324", "jpx", "spot_buy", "", "open", 100, "", 0, 100, "2022-01-23", "morning", "not_ordered", true)
...
func TestErrorOrdertype(t *testing.T) {
	o, err = order.New(1, "", "jpx", "spot_buy", "", "normal", 100, "", 0, 100, "2022-01-23", "morning", "waiting", false)
	assert.Nil(t, o)
	assert.Error(t, err)
}
